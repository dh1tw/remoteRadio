...
type State struct {
	...
	MeterUpdateRate int32    `protobuf:"varint,6,opt,name=meter_update_rate,json=meterUpdateRate,proto3" json:"meter_update_rate,omitempty"`
}
...
func (m *State) GetMeterUpdateRate() int32 {
	if m != nil {
		return m.MeterUpdateRate
	}
	return 0
}
...
func (m *State) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MeterUpdateRate != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintRadio(dAtA, i, uint64(m.MeterUpdateRate))
	}
	return i, nil
}
...
func (m *State) Size() (n int) {
	...
	if m.MeterUpdateRate != 0 {
		n += 1 + sovRadio(uint64(m.MeterUpdateRate))
	}
	return n
}
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MeterUpdateRate", wireType)
			}
			m.MeterUpdateRate = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MeterUpdateRate |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRadio = []byte{
	...
	,
}
