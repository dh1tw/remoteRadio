...
type Ping struct {
	PingOrigin string `protobuf:"bytes,1,opt,name=ping_origin,json=pingOrigin,proto3" json:"ping_origin,omitempty"`
...
func (m *Ping) GetPingOrigin() string {
	if m != nil {
		return m.PingOrigin
	}
	return ""
...
func (m *Ping) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PingOrigin) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintPing(dAtA, i, uint64(len(m.PingOrigin)))
...
func (m *Ping) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.PingOrigin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
...
var fileDescriptorPing = []byte{
	...
	0xd6, 0x03, 0x09, 0x2a, 0xb9, 0x72, 0xb1, 0x04, 0x64, 0xe6, 0xa5, 0x0b, 0xc9, 0x73, 0x71, 0x83,
	0xf8, 0xf1, 0xf9, 0x45, 0x99, 0xe9, 0x99, 0x79, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x60,
	0x7d, 0xfe, 0x60, 0x11, 0x21, 0x19, 0x2e, 0xce, 0x92, 0xcc, 0xdc, 0xd4, 0xe2, 0x92, 0xc4, 0xdc,
	0x02, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xe6, 0x20, 0x84, 0x80, 0x93, 0xc0, 0x89, 0x47, 0x72, 0x8c,
	0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0xd8,
	0x3a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xba, 0x45, 0x7b, 0x25, 0x7c, 0x00, 0x00, 0x00,
}
